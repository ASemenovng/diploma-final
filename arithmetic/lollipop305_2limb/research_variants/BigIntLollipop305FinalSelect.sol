...
/// @notice Экспериментальный вариант lollipop-305 с безветвительным финальным вычитанием модуля.
library BigIntLollipop305FinalSelect {
