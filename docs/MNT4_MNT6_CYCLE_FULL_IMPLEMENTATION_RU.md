...
Тест `both_reference_pairings_are_nontrivial_and_deterministic` строит pairing от стандартных генераторов на обеих кривых и проверяет, что результат детерминированный и не сводится к нулевому фиктивному значению.
